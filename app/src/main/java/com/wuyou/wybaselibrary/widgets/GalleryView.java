...
public class GalleryView extends RecyclerView {
    ...
    private void init() {
        ...
        setAdapter(adapter);
        adapter.setListener((holder, imageInfo) -> {
            //如果cell的点击是允许的，更新cell的状态，然后更新界面
            if (onItemSelect(imageInfo)) {
                int position = holder.getAdapterPosition();
                adapter.data.remove(position);
                adapter.data.add(position,imageInfo);
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> implements View.OnClickListener{
        ...
        public void replace(List<ImageInfo> newList){
            data.clear();
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.cell_gallery,parent,false);
        ...
        public void onClick(View v) {
            ...
            int position = holder.getAdapterPosition();
            if (listener!=null){
                listener.onItemClick(holder,data.get(position));
            }
        }
    }
    ...
    interface AdapterListener {
        //点击
        void onItemClick(ViewHolder holder,ImageInfo data);
    }
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(ImageInfo imageInfo) {
